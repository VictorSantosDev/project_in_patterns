...
Route::get('/reset/newPassword/{hash}', [RegisterController::class, 'resetNewPassword'])->name('reset-new-password');
Route::post('/reset/newPassword/user/{hash}', [RegisterController::class, 'resetNewPasswordUser'])->name('reset-new-password-user');
